...
let creatureName = "Spider-Chicken"; 

// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.

let creatureDescription = "A huge spider that looks like a chicken combined";
...
let vistorage = Math.floor(Math.random() * 60 + 1);
console.log(vistorage)
